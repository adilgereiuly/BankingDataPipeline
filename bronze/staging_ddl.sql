...
CREATE TABLE IF NOT EXISTS staging.account_products (
...
CREATE TABLE IF NOT EXISTS staging.card_bin_ranges (
...
CREATE TABLE IF NOT EXISTS staging.customer_contacts (
...
CREATE TABLE IF NOT EXISTS staging.merchant_categories (
...
CREATE TABLE IF NOT EXISTS staging.transaction_types (
...
CREATE TABLE IF NOT EXISTS staging.customer_changes (
